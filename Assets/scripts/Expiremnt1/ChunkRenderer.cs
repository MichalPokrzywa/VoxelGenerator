...
public class ChunkRenderer : MonoBehaviour
{
    ...
    public void InitalizeChunk(ChunkData data)
    {
        this.ChunkData = data;
    }
    ...
    private void OnDrawGizmo()
    {
        if (showGizmo)
        {
            if(Application.isPlaying && ChunkData != null)
            {
                ...
                Gizmos.DrawCube(transform.position + new Vector3(ChunkData.chunkSize /2f,ChunkData.chunkHeight/2f,ChunkData.chunkSize/2 ),
