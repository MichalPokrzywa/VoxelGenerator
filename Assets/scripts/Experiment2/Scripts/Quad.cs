/**
 * @file Quad.cs
 * @brief Defines the Quad class responsible for creating a quad mesh in Unity.
 */
...
/**
 * @class Quad
 * @brief Represents a quad mesh in Unity for a specific block side and type.
 */
public class Quad
{
    ...
    /**
     * @brief Constructor for creating a quad mesh.
     * @param side The block side for which the quad is created.
     * @param offset The offset position of the quad.
     * @param bType The block type determining the UV coordinates.
     */
